    ...
    <div className="flex-1 overflow-y-auto bg-plt-bg p-4 sm:p-6 md:p-10 font-sans max-w-4xl mx-auto custom-scrollbar">
        ...
        <div className="grid md:grid-cols-2 gap-3 mb-10">
          <div className="p-4 border-2 border-plt-accent/30 bg-plt-accent/[0.03] rounded-xl shadow-sm">
            <div className="flex items-center justify-between mb-2">
              ...
              <Badge className="text-[9px] tracking-wider">Default</Badge>
            </div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge variant="outline" className="text-[9px] tracking-wider text-slate-500">Robust</Badge>
              </div>
              <p className="text-xs text-plt-secondary leading-relaxed mb-3">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge variant="outline" className="text-[9px] tracking-wider text-slate-500">Baseline</Badge>
              </div>
              <p className="text-xs text-plt-secondary leading-relaxed mb-3">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <Badge variant="outline" className="text-[9px] tracking-wider text-slate-500">Fast</Badge>
              </div>
              <p className="text-xs text-plt-secondary leading-relaxed mb-3">
      ...
      <section className="mb-12">
        ...
        <Card>
          ...
          <div className="bg-plt-bg/50 p-5 font-sans font-bold text-[11px] text-plt-secondary border-t border-plt-border rounded-b-lg">
      ...
      <section className="mb-12">
        ...
        <Card>
          <CardContent className="p-6 text-center font-sans font-bold">
