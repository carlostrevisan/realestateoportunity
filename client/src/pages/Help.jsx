    ...
    <div className="flex-1 overflow-y-auto bg-plt-bg p-4 sm:p-6 md:p-10 font-sans max-w-4xl mx-auto custom-scrollbar">
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-3 md:gap-6">
          ...
          <div className="bg-plt-panel p-5 border border-plt-border rounded-lg shadow-sm">
            <div className="text-plt-accent font-mono text-xs mb-3 font-bold uppercase tracking-tighter">Phase 03 — Validation</div>
            <p className="text-xs leading-relaxed text-plt-text-secondary">
      ...
      <section className="mb-12">
        ...
        <div className="bg-plt-panel border border-plt-border rounded-lg overflow-hidden shadow-sm">
          ...
          <div className="p-4 sm:p-5 border-b border-plt-border grid md:grid-cols-2 gap-4 md:gap-8">
            <div>
              <h4 className="text-[10px] font-bold text-plt-accent uppercase mb-3 font-mono">Model Performance</h4>
              <div className="space-y-3">
                <div className="flex justify-between items-end border-b border-plt-border pb-1">
                  ...
                  <span className="text-sm font-mono font-bold text-plt-primary">20%</span>
                </div>
                <div className="flex justify-between items-end border-b border-plt-border pb-1">
                  <span className="text-xs font-semibold text-plt-text-secondary">Target Subsample</span>
                  <span className="text-sm font-mono font-bold text-plt-primary">0.8</span>
                </div>
          ...
          <div className="p-5">
            <h4 className="text-[10px] font-bold text-plt-accent uppercase mb-3 font-mono">Core Feature Inputs</h4>
      ...
      <section className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="p-4 border border-plt-border rounded-lg bg-plt-panel shadow-sm">
            <h4 className="text-[10px] font-bold text-plt-accent uppercase mb-2 font-mono tracking-widest">Market Context Toggle</h4>
          ...
          <div className="p-4 border border-plt-border rounded-lg bg-plt-panel shadow-sm">
            <h4 className="text-[10px] font-bold text-plt-accent uppercase mb-2 font-mono tracking-widest">Comparable Sales (Comps)</h4>
            <p className="text-xs text-plt-text-secondary">
      ...
      <section className="mb-12">
        ...
        <div className="bg-plt-panel p-6 border border-plt-border rounded-lg text-center font-mono shadow-sm">
      ...
      <footer className="mt-10 sm:mt-20 pt-6 sm:pt-10 border-t border-plt-border text-center pb-10">
        <p className="text-plt-muted text-[10px] font-mono uppercase tracking-[0.2em] font-bold">
